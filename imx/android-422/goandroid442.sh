...
# untar the tarball of the patched 4.3_1.1.0-ga source
# tar xvf android-4.3_r2.1_jb4.3_1.1.0_patched.tar.xz
#
...
FREESCALE_FSTAB_PATH=device/fsl/sabresd_6dq
...
SDMMC_FREESCALE_FSTAB_FILE=${FREESCALE_FSTAB_FILE}.sdmmc.442_100
EMMC_FREESCALE_FSTAB_FILE=${FREESCALE_FSTAB_FILE}.emmc.442_100
